...
def createActSpecSheet():
    ...
    workbook = xlsxwriter.Workbook(f'ActuatorSizing.xlsx')
    worksheet = workbook.add_worksheet()
    ...
    worksheet.insert_image('A4', 'logo.png', {'x_scale': 0.18, 'y_scale': 0.18})
    worksheet.merge_range('A3:B7', "", cell_format)
    ...
    worksheet.merge_range("B11:C11", 'Rating', cell_format)
    worksheet.merge_range("B12:C12", 'Valve Type', cell_format)
    worksheet.merge_range("B13:C13", 'Trim Type', cell_format)
    ...
    worksheet.merge_range("B34:C34", '', cell_format1)
    ...
    worksheet.merge_range('C8:L8', '', cell_format)
    worksheet.merge_range('C9:L9', '', cell_format)
    ...
    worksheet.merge_range('E3:G3', '', cell_format)
    worksheet.merge_range('E4:G4', '', cell_format)
    worksheet.merge_range('E5:G5', '', cell_format)
    worksheet.merge_range('E6:G6', '', cell_format)
    worksheet.merge_range('E7:G7', '', cell_format)

    worksheet.merge_range('I3:L3', '', cell_format)
    worksheet.merge_range('I4:L4', '', cell_format)
    worksheet.merge_range('I5:L5', '', cell_format)
    worksheet.merge_range('I6:L6', '', cell_format)
    worksheet.merge_range('I7:L7', '', cell_format)
    ...
    worksheet.write('D46', '', cell_format)
    worksheet.write('D47', '', cell_format)
    worksheet.write('D48', '', cell_format)
    ...
    worksheet.merge_range("E28:F28", '', cell_format)
    worksheet.merge_range("E29:F29", '', cell_format)
    worksheet.merge_range("E30:F30", '', cell_format)
    worksheet.merge_range("E31:F31", 'Values', bold)
    worksheet.merge_range("E32:F32", '', cell_format)
    worksheet.merge_range("E33:F33", '', cell_format)
    worksheet.merge_range("E34:F34", '', cell_format)
    ...
    worksheet.merge_range("E39:F39", '', cell_format)
    worksheet.merge_range("E40:F40", '', cell_format)
    worksheet.merge_range("E41:F41", '', cell_format)
    worksheet.merge_range("E42:F42", '', cell_format)
    ...
    worksheet.write('J14', '', cell_format)
    worksheet.write('J15', '', cell_format)
    worksheet.write('J16', '', cell_format)
    worksheet.write('J17', '', cell_format)
    worksheet.write('J18', '', cell_format)
    worksheet.write('J19', '', cell_format)
    worksheet.write('J20', '', cell_format)
    worksheet.write('J21', '', cell_format)
    worksheet.write('J22', '', cell_format)
    worksheet.write('J23', '', cell_format)
    worksheet.write('J24', '', cell_format)
    worksheet.write('J25', '', cell_format)
    ...
    worksheet.merge_range("K11:L11", '', cell_format)
    worksheet.merge_range("K12:L12", '', cell_format)
    worksheet.merge_range("K13:L13", '', cell_format)
    ...
    worksheet.merge_range("K32:L32", '', cell_format)
    worksheet.merge_range("K33:L33", '', cell_format)
    ...
    worksheet.merge_range("K39:L39", '', cell_format)
    worksheet.merge_range("K40:L40", '', cell_format)
