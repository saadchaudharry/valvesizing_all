...
def createSpecSheet(case_data, units, other, act_):
    ...
    for i in range(len(case_data)):
        ...
        worksheet.write('J53', act_['cleaning'], cell_format1)
        worksheet.write('J54', act_['paint_finish'], cell_format1)
        worksheet.write('J55', act_['product_certs'], cell_format1)
        ...
        worksheet.write(f'J31', f'{act_["air_supply_pressure"]}', cell_format1)
        ...
        worksheet.write(f'L37', act_['close'], cell_format1)
        ...
        worksheet.write(f'J43', 'See N4', cell_format1)
        ...
        worksheet.write(f'L48', 'See N5', cell_format1)
...
def createActSpecSheet(header_,valvedatas_,actdatas_,units_,accessories_):
    ...
    for i in range(len(header_)):
        ...
        worksheet.merge_range("B11:C11", 'Valve Type', cell_format)
        worksheet.merge_range("B12:C12", 'Trim Type', cell_format)
        worksheet.merge_range("B13:C13", 'Rating', cell_format)
        worksheet.merge_range("B14:C14", 'Balancing', cell_format)
        worksheet.merge_range("B15:C15", 'Flow Direction', cell_format)
        worksheet.merge_range("B16:C16", 'Valve Size', cell_format)
        worksheet.merge_range("B17:C17", 'Seat Diameter', cell_format)
        worksheet.merge_range("B18:C18", 'Unbalanced Area', cell_format)
        worksheet.merge_range("B19:C19", 'Valve Stem Size', cell_format)
        worksheet.merge_range("B20:C20", 'Valve Travel', cell_format)
        worksheet.merge_range("B21:C21", 'Packing Friction', cell_format)
        worksheet.merge_range("B22:C22", 'Seat Load Factor', cell_format)
        worksheet.merge_range("B23:C23", 'Additional Friction', cell_format)
        worksheet.merge_range("B24:C24", 'P1 Max', cell_format)
        worksheet.merge_range("B25:C25", 'P2 Min', cell_format)
        worksheet.merge_range("B26:C26", 'ΔP Shutoff', cell_format)
        worksheet.merge_range("B27:C27", 'Unbalance Force @Open', cell_format1)
        worksheet.merge_range("B28:C28", 'Fluid Negative Gradient', cell_format1)
        worksheet.merge_range("B29:C29", 'ΔP Flowing', cell_format1)
        worksheet.merge_range("B30:C30", '', cell_format1)

        worksheet.merge_range("B31:C31", 'Valve Force', bold)
        worksheet.merge_range("B32:C32", 'Valve Thrust (close)', cell_format1)
        worksheet.merge_range("B33:C33", 'Valve Thrust (open)', cell_format1)
        worksheet.merge_range("B34:C34", 'Shutoff Force', cell_format1)
        worksheet.merge_range("B35:C35", '', cell_format1)
        worksheet.merge_range("B36:C36", '', cell_format1)
        worksheet.merge_range("B37:C37", '', cell_format1)
        ...
        worksheet.write('D14', '', cell_format)
        worksheet.write('D15', '', cell_format)
        worksheet.write('D16', units_[i][0], cell_format)
        worksheet.write('D17', units_[i][1], cell_format)
        worksheet.write('D18', units_[i][2], cell_format)
        worksheet.write('D19', units_[i][3], cell_format)
        worksheet.write('D20', units_[i][4], cell_format)
        worksheet.write('D21', units_[i][5], cell_format)
        worksheet.write('D22', units_[i][6], cell_format)
        worksheet.write('D23', units_[i][7], cell_format)
        worksheet.write('D24', units_[i][8], cell_format)
        worksheet.write('D25', units_[i][9], cell_format)
        worksheet.write('D26', units_[i][10], cell_format)
        worksheet.write('D27', units_[i][11], cell_format)
        worksheet.write('D28', units_[i][12], cell_format)
        worksheet.write('D29', units_[i][13], cell_format)
        worksheet.write('D30', '', cell_format)
        worksheet.write('D31', 'Units', bold)
        worksheet.write('D32', units_[i][14], cell_format)
        worksheet.write('D33', units_[i][15], cell_format)
        worksheet.write('D34', units_[i][16], cell_format)
        worksheet.write('D35', '', cell_format)
        worksheet.write('D36', '', cell_format)
        worksheet.write('D37', '', cell_format)
        ...
        worksheet.merge_range("E32:F32", actdatas_[i][15], cell_format)
        worksheet.merge_range("E33:F33", actdatas_[i][16], cell_format)
        worksheet.merge_range("E34:F34", actdatas_[i][17], cell_format)
        worksheet.merge_range("E35:F35", '', cell_format)
        worksheet.merge_range("E36:F36", '', cell_format)
        worksheet.merge_range("E37:F37", '', cell_format)
        ...
        worksheet.merge_range("H11:I11", 'Actuator Type', cell_format)
        worksheet.merge_range("H12:I12", 'Air Fail Action', cell_format)
        worksheet.merge_range("H13:I13", 'Actuator Size', cell_format)
        worksheet.merge_range("H14:I14", 'Actuator Travel', cell_format)
        worksheet.merge_range("H15:I15", 'Diaphragm Effective Area', cell_format)
        worksheet.merge_range("H16:I16", 'Lower Bench Set', cell_format)
        worksheet.merge_range("H17:I17", 'Upper Bench Set', cell_format)
        worksheet.merge_range("H18:I18", 'Spring Rate', cell_format)
        worksheet.merge_range("H19:I19", 'Spring Windup', cell_format)
        worksheet.merge_range("H20:I20", 'Max Spring Load', cell_format)
        worksheet.merge_range("H21:I21", 'Max Air Supply', cell_format)
        worksheet.merge_range("H22:I22", 'Set Pressure', cell_format)
        worksheet.merge_range("H23:I23", 'Friction Band', cell_format)
        worksheet.merge_range("H24:I24", 'Req. HandWheel Thrust', cell_format)
        worksheet.merge_range("H25:I25", 'Max.Handwheel Thrust', cell_format)
        ...
        worksheet.merge_range("H32:I32", 'Actuator Thrust (Close)', cell_format)
        worksheet.merge_range("H33:I33", 'Actuator Thrust (Open)', cell_format)
        worksheet.merge_range("H34:I34", '', cell_format)
        worksheet.merge_range("H35:I35", '', cell_format)
        worksheet.merge_range("H36:I36", '', cell_format)
        worksheet.merge_range("H37:I37", '', cell_format)
        ...
        worksheet.write('J14', units_[i][17], cell_format)
        worksheet.write('J15', units_[i][18], cell_format)
        worksheet.write('J16', units_[i][19], cell_format)
        worksheet.write('J17', units_[i][20], cell_format)
        worksheet.write('J18', units_[i][21], cell_format)
        worksheet.write('J19', units_[i][22], cell_format)
        worksheet.write('J20', units_[i][23], cell_format)
        worksheet.write('J21', units_[i][24], cell_format)
        worksheet.write('J22', units_[i][25], cell_format)
        worksheet.write('J23', units_[i][26], cell_format)
        worksheet.write('J24', units_[i][27], cell_format)
        worksheet.write('J25', units_[i][28], cell_format)
        ...
        worksheet.write('J32', units_[i][29], cell_format)
        worksheet.write('J33', units_[i][30], cell_format)
        ...
        worksheet.write('J39', units_[i][31], cell_format)
        worksheet.write('J40', units_[i][32], cell_format)
        ...
        worksheet.merge_range("K32:L32", actdatas_[i][18], cell_format)
        worksheet.merge_range("K33:L33", actdatas_[i][19], cell_format)
        worksheet.merge_range("K34:L34", '', cell_format)
        worksheet.merge_range("K35:L35", '', cell_format)
        worksheet.merge_range("K36:L36", '', cell_format)
        worksheet.merge_range("K37:L37", '', cell_format)
        worksheet.merge_range("K38:L38", 'Stroke Time', bold)
        worksheet.merge_range("K39:L39", actdatas_[i][20], cell_format)
        worksheet.merge_range("K40:L40", actdatas_[i][21], cell_format)
